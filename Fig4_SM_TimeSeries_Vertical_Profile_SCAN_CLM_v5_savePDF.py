...
#    ax[-1].scatter(df_JJA.index, df_JJA[clmsmapKF_col].copy().mean(1),s = 5, c='forestgreen',label='CLM SMAP_KF')  <
    ...
    sc4 = ax[-1].scatter(df_JJA.index, df_JJA['SMAP_KF_h2osoi_5cm_' + st_names[cc]].copy(),s = 1.5, c='forestgreen',marker="h",label='SMAP_kf_BC/SMAP_kf')
    ...
    ln4 = ax[-1].plot(df_JJA.index, df_JJA['SMAP_KF_h2osoi_5cm_' + st_names[cc]].copy(),linewidth=0.5, linestyle =':',c='forestgreen',label='SMAP_kf_BC/SMAP_kf')
...
#%%======================================================================= Plotting the Whole timeseries
	...
	ax[-1].scatter(array_smapDailyCVEX, array((0.0071, 0.0279, 0.0623, 0.1189, 0.2122, 0.3661, 0.6198, 1.038))  ,s = 5 , c='forestgreen',marker='h', facecolors='forestgreen',label='CLM SMAP_kf')
