...
#%%================================= Plotting
fig = plt.figure(figsize=(8, 7.5)) #figsize: w,h  
...
map0=Basemap( projection ='cyl',  \
			llcrnrlon  = nxa,  \
			 ...
			 urcrnrlat  =  nya,  \
			 resolution = "c")
map0.drawcoastlines(linewidth=lwCOAST, color='black')
map0.drawcountries(linewidth=lwCONTRS, color='grey')
map0.drawstates(linewidth=lwSTS, color=clST)
cs0 = map0.imshow(ma.masked_equal(smap3min[:,:cntralUSA3minxy(30,-92)[0]]*IRRmask3min[:,:cntralUSA3minxy(30,-92)[0]],0.0),origin='upper',interpolation='nearest',cmap=cmap,norm=norm, vmin=0.0, vmax=0.3)
...
map0.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_07_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map0.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_08_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map0.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_10_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map0.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_11_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map0.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_12_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map0.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_13_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map0.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_14_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map0.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_15_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map0.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_16_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map0.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_17_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
# cbar0 = map1.colorbar(cs0,location='bottom', extend='max',pad="5%")
# cbar0.ax.tick_params(labelsize=5)
ax0.text(0.3, 0.85, '(a)', verticalalignment='bottom', horizontalalignment='right', transform=ax0.transAxes,fontsize=15)
plt.setp(ax0.spines.values(), color='darkgray')
plt.title('SMAP_Satellite',fontsize=10)
#================================================================================
...
map1=Basemap( projection ='cyl',  \
			llcrnrlon  = nxa,  \
			 ...
			 urcrnrlat  =  nya,  \
			 resolution = "c")
map1.drawcoastlines(linewidth=lwCOAST, color='black')
map1.drawcountries(linewidth=lwCONTRS, color='grey')
map1.drawstates(linewidth=lwSTS, color=clST)
cs1 = map1.imshow(ma.masked_equal(ctrl_h2osoi_zero0[0,:,:cntralUSA3minxy(30,-92)[0]]*IRRmask3min[:,:cntralUSA3minxy(30,-92)[0]],0.0),origin='upper',interpolation='nearest',cmap=cmap,norm=norm, vmin=0.0, vmax=0.3)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/HPA_outline_shapefile/HPA_outline', 'HPA_outline', linewidth=1)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_07_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_08_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_10_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_11_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_12_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_13_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_14_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_15_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_16_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map1.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_17_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
# cbar1 = map.colorbar(cs1,location='bottom', extend='max',pad="5%")
# cbar1.ax.tick_params(labelsize=5)
ax1.text(0.3, 0.85, '(b)', verticalalignment='bottom', horizontalalignment='right', transform=ax1.transAxes,fontsize=15)
plt.setp(ax1.spines.values(), color='darkgray')
plt.title('CTRL',fontsize=10)

#plt.title('Top 5cm SM (JJA Mean of ' + str(sYEAR) + '_' + str(eYEAR) + ')\n' + 'CTRL',fontsize=15)
cbar_ax = fig.add_axes([0.2, 0.515, 0.6, 0.01])    
cb = fig.colorbar(cs0, cax=cbar_ax, cmap=cmap, norm=norm,spacing='uniform', ticks=bounds_b,orientation='horizontal', extend='max')
cb.set_label('$mm^3/mm^3$',fontsize=8,labelpad=-22, x=1.09)
...
map2=Basemap( projection ='cyl',  \
			llcrnrlon  = nxa,  \
			 ...
			 urcrnrlat  =  nya,  \
			 resolution = "c")
map2.drawcoastlines(linewidth=lwCOAST, color='black')
map2.drawcountries(linewidth=lwCONTRS, color='grey')
map2.drawstates(linewidth=lwSTS, color=clST)
diff = smap_h2osoi_zero0[0,:,:cntralUSA3minxy(30,-92)[0]] - ctrl_h2osoi_zero0[0,:,:cntralUSA3minxy(30,-92)[0]]
fraction = (diff*IRRmask3min[:,:cntralUSA3minxy(30,-92)[0]])/ma.masked_equal(ctrl_h2osoi_zero0[0,:,:cntralUSA3minxy(30,-92)[0]]*IRRmask3min[:,:cntralUSA3minxy(30,-92)[0]],0.0)

cs2 = map2.imshow(ma.masked_equal(fraction*100,0.0),origin='upper',interpolation='nearest',cmap=cmap,norm=norm)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/HPA_outline_shapefile/HPA_outline', 'HPA_outline', linewidth=1)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_07_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_08_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_10_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_11_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_12_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_13_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_14_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_15_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_16_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
map2.readshapefile('/mnt/home/felfelan/CESM_DIRs/MyAnalysis/shp_files/WBD_17_Shape/Shape/WBDHU2', 'WBDHU2', linewidth=lwHU, color=clHU)
#plt.title(r'$\frac{SMAP_{kf} - CTRL}{CTRL}$' ,fontsize=15)
plt.title('% Change in SMAP_KF SM from CTRL' ,fontsize=10)
...
cb2.set_label('% Change',fontsize=8)
#cbar2 = map2.colorbar(cs2,location='bottom', extend='max',pad="5%")
#cbar2.ax.tick_params(labelsize=5)
ax2.text(0.3, 0.85, '(d)', verticalalignment='bottom', horizontalalignment='right', transform=ax2.transAxes,fontsize=15)
...
cs3 = map3.imshow(ma.masked_equal(diff3*IRRmask3min[:,:cntralUSA3minxy(30,-92)[0]],0.0),origin='upper',interpolation='nearest',cmap=cmap,norm=norm,vmax = 0.0)
...
plt.title('SMAP_Satellite - NOirrig',fontsize=10)
...
cb3.set_label('$mm^3/mm^3$',fontsize=8)
cb3.ax.tick_params(labelsize=8)
plt.setp(ax3.spines.values(), color='darkgray')

savefig(figDIR + 'Fig2_SMAP_CLMctrl_CLMSMAPKF_centralUSA_5cmSM_ave_' + str(sYEAR) + '_' + str(eYEAR) + '_v4.png', dpi=600, bbox_inches='tight')
# savefig(figDIR + 'Fig2_SMAP_CLMctrl_CLMSMAPKF_centralUSA_5cmSM_ave_' + str(sYEAR) + '_' + str(eYEAR) + '_v4.pdf', bbox_inches='tight')
