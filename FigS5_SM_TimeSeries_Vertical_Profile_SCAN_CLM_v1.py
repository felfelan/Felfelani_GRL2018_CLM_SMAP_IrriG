...
letter1 = ['a','b','c','d','e','f','g','h','k','m','n','p']
...
gs2.update(bottom=0.05, top=0.95, wspace=0.15)

fig = plt.figure(num=1, figsize=(25.5,13)) #figsize: w,h
ax = []
...
#%%======================================================================= Plotting the Whole timeseries
	...
	if 'SCAN' in tables:	
		...
		ax[-1].scatter(array_scan, array((0.05,0.1,0.2,0.5,1))  ,s = 20 , c='black',marker='s', facecolors='black',label='SNOTEL')
	else:
...
savefig( figDIR + 'FigS3_Ave_SM_vertical_X021_X024_X024kf_JJA_' + sDate_V + '_' + eDate_V + '_v1.png', bbox_inches='tight', dpi=600 )
