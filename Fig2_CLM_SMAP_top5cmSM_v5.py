...
plt.title('SMAP_Satellite',fontsize=12)
#================================================================================
...
plt.title('% Change in SMAP_kf SM from CTRL' ,fontsize=12)
...
plt.title('SMAP_Satellite - NOirrig',fontsize=12)
...
# savefig(figDIR + 'Fig2_SMAP_CLMctrl_CLMSMAPKF_centralUSA_5cmSM_ave_' + str(sYEAR) + '_' + str(eYEAR) + '_v3f.png', dpi=600, bbox_inches='tight')
savefig(figDIR + 'Fig2_SMAP_CLMctrl_CLMSMAPKF_centralUSA_5cmSM_ave_' + str(sYEAR) + '_' + str(eYEAR) + '_v3f.pdf', bbox_inches='tight')
