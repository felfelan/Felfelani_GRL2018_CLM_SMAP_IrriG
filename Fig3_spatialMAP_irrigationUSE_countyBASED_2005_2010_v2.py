...
savefig( figDIR + 'Fig3_irrigation_amount_spatialMap_spatiotemporalKF_minIRRIG_Finalallkm_2005_2010_v5' + '.png', bbox_inches='tight', dpi=600 )
#savefig( figDIR + 'Fig3_irrigation_amount_spatialMap_spatiotemporalKF_minIRRIG_Finalallkm_2005_2010_v5' + '.pdf', bbox_inches='tight' )
#
plt.close()
