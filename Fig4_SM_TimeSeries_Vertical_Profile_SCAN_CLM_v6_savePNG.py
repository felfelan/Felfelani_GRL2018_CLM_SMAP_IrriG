...
savefig( figDIR + 'Fig4_SM_timeseriesLHPA_' + sDate_T + eDate_T + '_Ave_SM_vertical_X021_X024_X024kf_JJA' + '_' + sDate_V + '_' + eDate_V + '_v7.png', bbox_inches='tight', dpi=600 )
# savefig( figDIR + 'Fig4_SM_timeseriesLPHA_' + sDate_T + eDate_T + '_Ave_SM_vertical_X021_X024_X024kf_JJA' + '_' + sDate_V + '_' + eDate_V + '_v7.pdf', bbox_inches='tight')
